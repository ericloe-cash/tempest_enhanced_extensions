...
data class ParallelVersionedAttribute(
  ...
  val one_created_at_instant: Instant? = null,
  val one_updated_at_instant: Instant? = null,

  val two_version: Long? = null,
  val two_created_at_instant: Instant? = null,
  val two_updated_at_instant: Instant? = null,

  val three_version: Long? = null,
  val three_created_at_instant: Instant? = null,
  val three_updated_at_instant: Instant? = null,

  val four_version: Long? = null,
  val four_created_at_instant: Instant? = null,
  val four_updated_at_instant: Instant? = null,
