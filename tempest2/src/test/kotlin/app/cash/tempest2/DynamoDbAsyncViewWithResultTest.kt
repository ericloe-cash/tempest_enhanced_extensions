  ...
  fun parallelSaveWithResult() = runBlocking(multiThreadedCoroutineDispatcher) {
      ...
      async {
        ...
        val two = versionedAttributeTable.parallelAttributes.saveWithResult(
          one.copy(
            ...
            one_created_at_instant = one.created_at_instant!!,
            one_updated_at_instant = one.updated_at_instant!!,
          )
        )
        ...
        val three = versionedAttributeTable.parallelAttributes.saveWithResult(
          two.copy(
            ...
            two_created_at_instant = two.created_at_instant!!,
            two_updated_at_instant = two.updated_at_instant!!,
          )
        )
        ...
        val four = versionedAttributeTable.parallelAttributes.saveWithResult(
          three.copy(
            ...
            three_created_at_instant = three.created_at_instant!!,
            three_updated_at_instant = three.updated_at_instant!!,
          )
        )
        ...
        val five = versionedAttributeTable.parallelAttributes.saveWithResult(
          four.copy(
            ...
            four_created_at_instant = four.created_at_instant!!,
            four_updated_at_instant = four.updated_at_instant!!,
          )
        )
    ...
    items.forEach {
      ...
      if (expectedVersion == 1L) {
        // No updates, updated and created should match.
        assertThat(it.updated_at_instant).isEqualTo(it.created_at_instant)
        assertThat(it.one_version).isNull()
        assertThat(it.one_created_at_instant).isNull()
        assertThat(it.one_updated_at_instant).isNull()
        seenUpdatedAts.add(it.created_at_instant!!)
      ...
      if (expectedVersion >= 2L) {
        ...
        assertThat(it.one_created_at_instant).isEqualTo(it.created_at_instant)
        assertThat(it.one_updated_at_instant).isEqualTo(it.one_created_at_instant)
        assertThat(it.one_updated_at_instant).isBefore(it.updated_at_instant)
        seenUpdatedAts.add(it.one_updated_at_instant!!)
      }
      ...
      if (expectedVersion >= 3L) {
        ...
        assertThat(it.two_created_at_instant).isEqualTo(it.created_at_instant)
        assertThat(it.two_updated_at_instant).isBefore(it.updated_at_instant)
        assertThat(it.two_updated_at_instant).isAfter(it.one_updated_at_instant)
        seenUpdatedAts.add(it.two_updated_at_instant!!)
      }

      if (expectedVersion >= 4L) {
        assertThat(descriptionParts[3]).isEqualTo(3)
        assertThat(it.three_version).isEqualTo(3)
        assertThat(it.three_created_at_instant).isEqualTo(it.created_at_instant)
        assertThat(it.three_updated_at_instant).isBefore(it.updated_at_instant)
        assertThat(it.three_updated_at_instant).isAfter(it.two_updated_at_instant)
        seenUpdatedAts.add(it.three_updated_at_instant!!)
      }

      if (expectedVersion == 5L) {
        assertThat(descriptionParts[4]).isEqualTo(4)
        assertThat(it.four_version).isEqualTo(4)
        assertThat(it.four_created_at_instant).isEqualTo(it.created_at_instant)
        assertThat(it.four_updated_at_instant).isBefore(it.updated_at_instant)
        assertThat(it.four_updated_at_instant).isAfter(it.three_updated_at_instant)
        seenUpdatedAts.add(it.four_updated_at_instant!!)
      }
    }
